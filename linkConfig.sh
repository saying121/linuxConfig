...
link_list=(
    ["$dot_dir/configs/f-sy-h"]="$HOME/.config"
    ["$dot_dir/configs/rizin"]="$HOME/.config"
    ...
    ["$dot_dir/configs/nvim"]="$HOME/.config"
    ["$dot_dir/configs/betterlockscreen"]="$HOME/.config"
    ["$dot_dir/configs/hypr"]="$HOME/.config"
    ["$dot_dir/configs/swaylock"]="$HOME/.config"
    ["$dot_dir/configs/waybar"]="$HOME/.config"
