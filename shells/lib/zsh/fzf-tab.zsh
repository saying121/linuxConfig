...
zstyle ':fzf-tab:complete:*:*' fzf-flags --height=60% --preview-window=down:3:wrap
...
zstyle ':fzf-tab:complete:awww:*' fzf-flags --preview-window=right
...
zstyle ':fzf-tab:complete:(rustup):argument-2' fzf-flags --preview-window=down:3:wrap --height=50%

# gcc in macos is gcc-14, g++-14 etc
zstyle ':fzf-tab:complete:(gcc*):options' fzf-flags --preview-window=down:3:wrap --height=50%
