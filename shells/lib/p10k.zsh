# Generated by Powerlevel10k configuration wizard on 2023-04-18 at 23:14 CST.
...
() {
    ...
    typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=( # =========================[ Line #1 ]========================= status                  # exit code of the last command
    ...
    typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_PREFIX='%F{%(#.blue.green)}┌─'
    ...
    function my_git_formatter() {
        ...
        typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND=027
        ...
        typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE="%n$prompt_symbol%m"
        unset prompt_symbol
